...
public class DebugWindow : EditorWindow
{
    ...
    [MenuItem("Tools/Debugging/Debug Window")]
    public static void ShowWindow()
    {
        ...
        Texture2D icon = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/_Project/Editor/Icons/Debug.png");
    ...
    static void DrawDebugOptionsMenu()
    {
        ...
        using (new VerticalScope("box"))
        {
            ...
            if (optionsFoldout)
            {
                ...
                var debugModeContent = new GUIContent("Debug Mode", "Allows the developer to skip the loading screen, join a player into the game scene directly, among with some other minor QoL changes");
                var resetPersistentPlayersContent = new GUIContent("Reset Persistent Players", "Resets the persistent players in the scene. Useful for debugging purposes.");
                ...
                Logger.DebugMode                           = EditorGUILayout.Toggle(debugModeContent, Logger.DebugMode);
                Logger.ResetPersistentPlayers              = EditorGUILayout.Toggle(resetPersistentPlayersContent, Logger.ResetPersistentPlayers);
            }
        }
    }
    ...
    static void HelpCommand()
    {
        ...
        else Logger.Log("Commands can be viewed from the commands list at the bottom of the" + nameof(DebugWindow), LogType.Log);
    }
    static void HitboxCommand(string message)
    {
        ...
        {
            hitbox.MoveData.damage = newDamage;
