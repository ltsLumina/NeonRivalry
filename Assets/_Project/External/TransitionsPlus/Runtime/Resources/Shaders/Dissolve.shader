Shader "TransitionsPlus/Dissolve"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                i.uv.x *= GetAspectRatio();
                float2 cellCoords = floor(i.uv * CELL_DIVISIONS);

                float t = _T;

                float timeShift = Rand(7.7 * _Seed + cellCoords);
                float t0 = t - timeShift;
                t = t0 / (1.0001 - timeShift);

                fixed fade = saturate(t);
